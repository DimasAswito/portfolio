            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-end mb-4">
                        <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add Experience</button>
                    </div>
                        ...
                        <table class="table-auto w-full border-collapse border border-gray-300 dark:border-gray-600">
                            <thead>
                                <tr class="bg-gray-100 dark:bg-gray-700">
                                    ...
                                    <th class="border border-gray-300 dark:border-gray-600 px-4 py-2">Company</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">{{ $exp->order_number }}</td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">{{ $exp->title }}</td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">{{ $exp->company }}</td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">{{ $exp->status_label }}</td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-sm">{{ $exp->start_date }} - {{ $exp->end_date ?? 'Present' }}</td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">
                                        <button wire:click="edit({{ $exp->id }})" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-1 px-3 rounded">Edit</button>
                                        <button wire:click="delete({{ $exp->id }})" wire:confirm="Are you sure you want to delete this?" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-3 rounded mt-1">Delete</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                    ...
                    <form>
                        <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="mb-4">
                                    <label class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">Company:</label>
                                    <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 dark:text-white dark:bg-gray-900 dark:border-gray-700 leading-tight focus:outline-none" wire:model="company">
                                ...
                                <div class="mb-4">
                                    <label class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">Status Label (e.g. Full-time):</label>
                                    <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 dark:text-white dark:bg-gray-900 dark:border-gray-700 leading-tight focus:outline-none" wire:model="status_label">
                                    @error('status_label') <span class="text-red-500 text-xs">{{ $message }}</span>@enderror
                                </div>
                                <div class="mb-4">
