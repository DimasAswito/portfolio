            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-end mb-4">
                        <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add Project</button>
                    </div>
                        ...
                        <table class="table-auto w-full border-collapse border border-gray-300 dark:border-gray-600">
                            <thead>
                                <tr class="bg-gray-100 dark:bg-gray-700">
                                    ...
                                    <th class="border border-gray-300 dark:border-gray-600 px-4 py-2">URLs</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">{{ $project->order_number }}</td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">
                                        @if($project->image_path)
                                            <img src="{{ asset('storage/' . $project->image_path) }}" alt="{{ $project->title }}" class="w-16 h-16 object-cover rounded">
                                        @endif
                                    </td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">{{ $project->title }}</td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-sm">
                                        @if($project->project_url) <a href="{{ $project->project_url }}" target="_blank" class="text-blue-500">Live</a><br> @endif
                                        @if($project->github_url) <a href="{{ $project->github_url }}" target="_blank" class="text-blue-500">GitHub</a> @endif
                                    </td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">
                                        <button wire:click="edit({{ $project->id }})" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-1 px-3 rounded">Edit</button>
                                        <button wire:click="delete({{ $project->id }})" wire:confirm="Are you sure you want to delete this?" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-3 rounded mt-1">Delete</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                        ...
                        <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="grid grid-cols-2 gap-4">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 dark:text-white dark:bg-gray-900 dark:border-gray-700 leading-tight focus:outline-none" wire:model="title">
                                ...
                                <div class="mb-4">
                                    <label class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">Project URL:</label>
                                    <input type="url" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 dark:text-white dark:bg-gray-900 dark:border-gray-700 leading-tight focus:outline-none" wire:model="project_url">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="url" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 dark:text-white dark:bg-gray-900 dark:border-gray-700 leading-tight focus:outline-none" wire:model="github_url">
                                ...
                                <div class="mb-4 col-span-2">
                                    ...
                                    <input type="file" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 leading-tight focus:outline-none" wire:model="new_image">
                                    ...
                                    @if ($new_image)
                                        <div class="mt-2">Preview: <img src="{{ $new_image->temporaryUrl() }}" class="w-32 h-32 object-cover"></div>
                                    @elseif ($image_path)
                                        <div class="mt-2">Current: <img src="{{ asset('storage/' . $image_path) }}" class="w-32 h-32 object-cover"></div>
                                    @endif
                                </div>
                            </div>
                        </div>
