            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-end mb-4">
                        <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add Social Link</button>
                    </div>
                        ...
                        <table class="table-auto w-full border-collapse border border-gray-300 dark:border-gray-600">
                            <thead>
                                <tr class="bg-gray-100 dark:bg-gray-700">
                                    ...
                                    <th class="border border-gray-300 dark:border-gray-600 px-4 py-2">Platform</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">{{ $link->order_number }}</td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">{{ $link->platform }}</td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">{{ $link->url }}</td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">{{ $link->icon_class }}</td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">
                                        <button wire:click="edit({{ $link->id }})" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-1 px-3 rounded">Edit</button>
                                        <button wire:click="delete({{ $link->id }})" wire:confirm="Are you sure you want to delete this?" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-3 rounded mt-1 sm:mt-0">Delete</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                ...
                <div class="relative z-20 inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    <form>
                        <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="mb-4">
                                <label class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">Platform:</label>
                                <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 dark:text-white dark:bg-gray-900 dark:border-gray-700 leading-tight focus:outline-none" wire:model="platform">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="url" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 dark:text-white dark:bg-gray-900 dark:border-gray-700 leading-tight focus:outline-none" wire:model="url">
